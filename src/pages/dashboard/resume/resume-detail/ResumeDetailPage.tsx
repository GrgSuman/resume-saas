...
import SettingsNew from "./editor/SettingsNew";
import DownloadingUI from "./editor/DownloadingUI";
import Chat from "./chats/Chat";
import { useResume } from "../../../../hooks/useResume";
import LoadingResumeDetail from "./editor/LoadingResumeDetail";
import TEMPLATE_REGISTRY from "./editor/templates/TemplateRegistry";
  ...
  return (
    <>
      ...
      {state === null || state.resumeLoading ? (
        ...
        <div className="h-[100vh] flex flex-col xl:flex-row overflow-hidden bg-[#f5f5f5] relative">
          {/* LEFT: Resume Preview */}
